        ...
        <div class="swiper-slide max-md:!w-[286px] max-md:shrink-0">
          <div class="flex flex-col items-center group cursor-pointer w-full">
            ...
            <div class="w-full px-2 md:px-4 max-md:px-0">
              <a href="{{ asset('assets/images/award-01.jpg') }}" class="glightbox block w-full aspect-[3/4] overflow-hidden shadow-lg transition-transform duration-500 hover:-translate-y-2" data-gallery="certificates">
                <img src="{{ asset('assets/images/award-01.jpg') }}" alt="Kết quả thử nghiệm 2016" class="w-full h-full object-cover" />
              </a>
            </div>
          </div>
        </div>

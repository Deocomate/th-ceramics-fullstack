<x-client.layouts.main title="Chính sách đổi trả - Dịch vụ khách hàng" data-page="customer-service" main-class="bg-background-secondary min-h-screen font-archivo">

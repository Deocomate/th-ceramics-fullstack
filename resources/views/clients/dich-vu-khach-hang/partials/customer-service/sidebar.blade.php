<aside class="w-full lg:w-[320px] shrink-0">
  ...
  <div id="mobile-sidebar-toggle"
    ...
    <svg id="mobile-sidebar-chevron" style="transform: rotate(90deg)" class="transition-transform duration-300" width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5 3L9 7L5 11" stroke="#2E2F2A" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  ...
  <div id="sidebar-content"
    ...
    <nav class="flex flex-col lg:border-t border-gray-300 text-sm">
      ...
      <div id="sidebar-items-initial" class="flex flex-col">
        ...
        <a href="{{ route('client.customer-service.show', 'tai-catalog') }}"

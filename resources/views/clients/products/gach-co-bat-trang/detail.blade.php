<x-layouts.client title="Gạch Cổ Bát Tràng" data-page="products" main-class="bg-background-secondary pb-14 md:pb-20" :hide-newsletter="true">
...
<section class="hidden md:flex relative w-full h-[180px] md:h-[210px] items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center text-white px-4 pt-4">
        ...
        <p class="text-xs md:text-sm text-white/80">
            ...
            <a href="{{ route('client.products.gach-co-bat-trang.index') }}" class="hover:text-white transition-colors">Gạch Cổ Bát Tràng</a>
        </p>
    </div>
</section>

...
<section class="hidden md:flex relative w-full h-[180px] md:h-[210px] items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="{{ !empty($product->images) && is_array($product->images) && isset($product->images[0]) ? asset('storage/' . $product->images[0]) : asset('assets/images/detail-banner.png') }}" alt="{{ $product->name ?? 'Gạch Hoa Thông Gió' }} Banner" class="w-full h-full object-cover" />
    </div>

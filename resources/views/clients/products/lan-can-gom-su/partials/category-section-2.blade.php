    ...
    <div class="flex flex-col lg:flex-row gap-8 lg:gap-16 max-w-[1320px] ml-auto">
      <div class="w-full lg:w-[45%] ml-0 lg:ml-[10%] flex flex-col justify-stretch">
        <div
          ...
          <img src="{{ asset('assets/images/lan-can-bau.png') }}" alt="" class="absolute inset-0 w-full h-full object-cover" />
          <div
        ...
        <div class="grid grid-cols-2 gap-x-4 md:gap-x-8 lg:gap-x-16 gap-y-6 md:gap-y-10 lg:gap-y-12 mb-6 md:mb-10">
          <div class="flex flex-col group cursor-pointer" onclick="window.location.href = '#'">
            <div
              ...
              <img src="{{ asset('assets/images/lan-can-02.jpg') }}" alt="" class="w-full h-full object-cover" />
          ...
          <div class="flex flex-col group cursor-pointer" onclick="window.location.href = '#'">
            <div
              class="product-card relative w-full aspect-square mb-4 flex items-center justify-center overflow-hidden transition-all duration-300 group-hover:-translate-y-1 shadow-md">
              <img src="{{ asset('assets/images/lan-can-04.jpg') }}" alt="" class="w-full h-full object-cover" />
              <div class="product-overlay">
                <img src="{{ asset('assets/images/eye.svg') }}" alt="Search" />
                <span>Xem chi tiết</span>
              </div>
          ...
          <div class="flex flex-col group cursor-pointer" onclick="window.location.href = '#'">
            <div
              class="product-card relative w-full aspect-square mb-4 flex items-center justify-center overflow-hidden transition-all duration-300 group-hover:-translate-y-1 shadow-md">
              <img src="{{ asset('assets/images/lan-can-05.jpg') }}" alt="" class="w-full h-full object-cover" />
              <div class="product-overlay">
                <img src="{{ asset('assets/images/eye.svg') }}" alt="Search" />
                <span>Xem chi tiết</span>
              </div>
          ...
          <div class="flex flex-col group cursor-pointer" onclick="window.location.href = '#'">
            <div
              class="product-card relative w-full aspect-square mb-4 flex items-center justify-center overflow-hidden transition-all duration-300 group-hover:-translate-y-1 shadow-md">
              <img src="{{ asset('assets/images/lan-can-06.jpg') }}" alt="" class="w-full h-full object-cover" />
              <div class="product-overlay">
                <img src="{{ asset('assets/images/eye.svg') }}" alt="Search" />
                <span>Xem chi tiết</span>
              </div>

...
<section class="relative w-full">
  <div class="relative w-full aspect-[4/3] md:aspect-[8/6] lg:aspect-auto h-full lg:[clip-path:inset(40px_0_0_0)] lg:-mt-[40px]">
    <img src="{{ $assetUrl($config->thumbnail_main, 'assets/images/pk-banner.png') }}" alt="Phụ Kiện Ngói" class="w-full h-full object-cover">
    <div class="absolute inset-0 flex flex-col items-center pt-[5%] md:pt-[5%] lg:pt-[5%]" data-aos="fade-up" data-aos-delay="100">
      <div class="text-center text-white px-4 w-[85%] max-w-[1320px] mx-auto">
        <h1 class="font-sans text-[26px] md:text-4xl lg:text-[44px] font-bold uppercase mb-2 md:mb-6 drop-shadow-md">
          PHỤ KIỆN NGÓI
        </h1>
        <p class="font-italianno text-xl md:text-[34px] lg:text-[48px] font-light leading-none tracking-wide drop-shadow-sm text-white/95">
...
@php
  ...
  $masonryItems = [
      ['wrapper' => 'col-span-2 lg:col-start-2 lg:col-span-3', 'card' => 'aspect-[2/1] lg:aspect-[2.8/1]', 'delay' => '0'],
...
<section class="relative mx-auto pb-10 lg:pb-16 overflow-visible">
  <img src="{{ asset('assets/images/pk-decorate-left.svg') }}" alt="" class="absolute top-10 lg:-top-[11%] left-0 w-[60%] max-w-[400px] lg:max-w-[620px] opacity-70 z-0 pointer-events-none" data-aos="fade-right" data-aos-duration="1000">
  <img src="{{ asset('assets/images/pk-decorate-right.svg') }}" alt="" class="absolute bottom-[-5%] lg:bottom-[-18%] right-0 w-[70%] max-w-[500px] lg:max-w-[780px] opacity-70 z-0 pointer-events-none" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="flex flex-col gap-2 md:gap-4">
      <div class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 items-end">
        <div class="col-span-1" data-aos="fade-up" data-aos-delay="0">
          <a href="{{ $galleryImage(0) }}" class="glightbox w-full aspect-[1.1/1] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(0) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
        ...
        <div class="col-span-2 hidden md:block" data-aos="fade-up" data-aos-delay="200">
          <a href="{{ $galleryImage(1) }}" class="glightbox w-full aspect-[11/5] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(1) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 md:hidden gap-2 md:gap-4" data-aos="fade-up" data-aos-delay="200">
        <div class="col-span-1">
          <a href="{{ $galleryImage(1) }}" class="glightbox w-full aspect-[22/10] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(1) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
      </div>
      ...
      <div class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 items-start">
        <div class="col-span-1 row-span-2 md:row-span-1 h-full" data-aos="fade-up" data-aos-delay="0">
          <a href="{{ $galleryImage(2) }}" class="glightbox w-full h-full md:aspect-[8/10] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(2) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
        <div class="contents md:flex md:flex-col md:gap-4">
          <a href="{{ $galleryImage(3) }}" class="glightbox w-full aspect-[8/10] shadow overflow-hidden relative group block" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ $galleryImage(3) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
          <div class="w-full aspect-[19/10] bg-[#BD724F] shadow" data-aos="fade-up" data-aos-delay="200"></div>
        </div>
        <div class="col-span-1" data-aos="fade-up" data-aos-delay="200">
          <a href="{{ $galleryImage(4) }}" class="glightbox w-full aspect-[8/10] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(4) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
        <div class="col-span-1" data-aos="fade-up" data-aos-delay="300">
          <a href="{{ $galleryImage(5) }}" class="glightbox w-full aspect-[8/10] shadow overflow-hidden relative group block">
            <img src="{{ $galleryImage(5) }}" alt="" class="absolute inset-0 w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
          </a>
        </div>
      </div>

      <div class="mt-4 md:mt-6 flex justify-end items-center" data-aos="fade-up">
        <a href="{{ route('client.projects.index') }}" class="font-archivo text-sm md:text-base font-bold uppercase tracking-[0.08em] text-secondary transition-opacity duration-300 hover:opacity-70 inline-flex items-center gap-2">
          Xem thêm

<section class="w-full pb-16 animate-fade-in-up" data-product-section>
    ...
    >
      <article class="flex-shrink-0 w-full snap-start pb-1" data-product-slide>
        <div class="grid grid-cols-2 gap-4">
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-01.jpg') }}" alt="Riềm Âm Dương Sen Bầu"
            title="Riềm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-05.jpg') }}" alt="Riềm Âm Dương Sen Bầu"
            title="Riềm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-06.jpg') }}" alt="Riềm Âm Dương Sen Bầu"
            title="Riềm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-07.jpg') }}" alt="Riềm Âm Dương Sen Bầu"
            title="Riềm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
      ...
      <article class="flex-shrink-0 w-full snap-start pb-1" data-product-slide>
        <div class="grid grid-cols-2 gap-4">
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-05.jpg') }}" alt="Rìm Âm Dương Sen Bầu"
            title="Rìm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
            code-class="text-gray-500 text-[12px] leading-[20px]"
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-06.jpg') }}" alt="Rìm Âm Dương Sen Bầu"
            title="Rìm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
          ...
          <x-products.product-card
            href="/products/den-gom-su/detail.html"
            image="{{ asset('assets/images/ngoi-07.jpg') }}" alt="Rìm Âm Dương Sen Bầu"
            title="Rìm âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2"
            wrapper-class="flex flex-col group cursor-pointer"
            image-container-class="bg-white shadow-[0px_4px_4px_0px_rgba(0,0,0,0.1)] overflow-hidden aspect-square"
            title-class="mt-3 text-black font-semibold text-[14px] leading-[20px] uppercase"
  ...
  <div
    ...
    data-aos-delay="200"
  >
    <x-products.product-card href="/products/den-gom-su/detail.html"
    image="{{ asset('assets/images/ngoi-01.jpg') }}" alt="Rìm Âm Dương Sen Bầu" title="Rìm
    âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2" price-prefix="Giá"
    :show-overlay="true" />
    <x-products.product-card
    href="/products/den-gom-su/detail.html" image="{{ asset('assets/images/ngoi-05.jpg') }}"
    alt="Rìm Âm Dương Sen Bầu" title="Rìm âm dương sen bầu" code="MSP:
    1234RDS" price="675.000 đ/m2" price-prefix="Giá" :show-overlay="true" />
    <x-products.product-card href="/products/den-gom-su/detail.html"
    image="{{ asset('assets/images/ngoi-06.jpg') }}" alt="Rìm Âm Dương Sen Bầu" title="Rìm
    âm dương sen bầu" code="MSP: 1234RDS" price="675.000 đ/m2" price-prefix="Giá"
    :show-overlay="true" />
    <x-products.product-card
    href="/products/den-gom-su/detail.html" image="{{ asset('assets/images/ngoi-07.jpg') }}"
    alt="Rìm Âm Dương Sen Bầu" title="Rìm âm dương sen bầu" code="MSP:
    1234RDS" price="675.000 đ/m2" price-prefix="Giá" :show-overlay="true" />
    <x-products.product-card href="/products/den-gom-su/detail.html"
    image="{{ asset('assets/images/ngoi-01.jpg') }}" alt="Rìm Âm Dương Sen Bầu" title="Rìm

...
<section class="hidden md:flex relative w-full h-[180px] md:h-[210px] items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        <img src="{{ asset('assets/images/detail-banner.png') }}" alt="Gạch Trang Trí Banner" class="w-full h-full object-cover" />
    </div>
...
<div class="flex flex-col md:block">
    <div class="order-2 md:order-none">
        <x-products.quantity-calculator image="{{ $product->size_image ? Storage::url($product->size_image) : asset('assets/images/gtt-size.png') }}" />
    </div>

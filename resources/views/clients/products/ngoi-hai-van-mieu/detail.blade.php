<x-layouts.client title="Ngói Hài Văn Miếu" data-page="products" main-class="bg-background-secondary pb-14 md:pb-20" :hide-newsletter="true">
...
<section class="hidden md:flex relative w-full h-[180px] md:h-[210px] items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 text-center text-white px-4 pt-4">
        ...
        <p class="text-xs md:text-sm text-white/80">
            ...
            <a href="{{ route('client.products.ngoi-hai-van-mieu.index') }}" class="hover:text-white transition-colors">Ngói Hài Văn Miếu</a>
        </p>
    </div>
</section>
...
<div class="hidden md:block w-[85%] max-w-[1320px] mx-auto py-8">
    <x-products.breadcrumb current-label="Ngói Hài Văn Miếu" parent-label="Sản phẩm" parent-href="{{ route('client.products.ngoi-hai-van-mieu.index') }}" />

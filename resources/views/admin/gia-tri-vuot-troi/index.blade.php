    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <div class="p-6">
            ...
            <div class="mb-10 p-6 bg-blue-50/30 rounded-xl border border-blue-100 shadow-[0_0_15px_rgba(59,130,246,0.03)]">
                ...
                <form method="POST" action="{{ route('admin.gia-tri-vuot-troi.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        <div class="lg:col-span-1">
                            ...
                            <div class="w-[300px] h-[460px] mx-auto rounded-xl border-2 border-dashed border-blue-300 bg-white flex items-center justify-center overflow-hidden relative group hover:bg-blue-50/50 transition-colors">
                                <img id="preview-new-giatri" src="https://placehold.co/300x500?text=Chon+Anh" class="w-full h-full object-contain" alt="Preview">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                @forelse($giaTriVuotTroi as $giaTri)
                    <div class="border border-gray-200 rounded-xl overflow-hidden hover:shadow-lg transition-shadow bg-white flex flex-col group relative">
                        <div class="w-[300px] h-[460px] mx-auto mt-4 relative bg-gray-100 flex-shrink-0 rounded-xl overflow-hidden border border-gray-100">
                            <img src="{{ asset('storage/' . $giaTri->image) }}" onerror="this.src='https://placehold.co/300x500?text=Loi+Anh'" class="w-full h-full object-contain">
                            <div class="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col items-center justify-center gap-3 backdrop-blur-[2px]">
                                <button type="button" 
                                    ...
                                    onclick="openEditModal(this, '{{ route('admin.gia-tri-vuot-troi.update', $giaTri->gia_tri_vuot_troi_id) }}')"
                                ...
                                <button type="button" 
                                    onclick="openDeleteModal('{{ route('admin.gia-tri-vuot-troi.destroy', $giaTri->gia_tri_vuot_troi_id) }}')"

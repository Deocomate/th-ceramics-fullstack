<x-admin.layouts.app title="Sản phẩm: Lan Can Gốm Sứ" breadcrumb="Admin › DS Sản phẩm chi tiết › Lan Can Gốm Sứ">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
        @include('admin.partials.bulk-rename-products', ['type' => 'lan-can-gom-su-ct'])
                ...
                @forelse($products as $product)
                        ...
                        <td class="px-6 py-4 text-right">
                            <div class="flex justify-end gap-2">
                                @if(!$product->is_delete)
                                    <a href="{{ route('admin.lan-can-gom-su-ct.create', ['copy_from' => $product->lan_can_gom_su_ct_id]) }}" class="p-2 text-indigo-600 hover:bg-indigo-50 rounded-lg transition-colors" title="Nhân bản / Sao chép sản phẩm">

<x-admin.layouts.app title="Thêm Gạch Trang Trí" breadcrumb="Admin › DS Sản phẩm chi tiết › Thêm mới">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        <div class="px-6 py-4 border-b border-gray-100 bg-gray-50 flex items-center justify-between">
            ...
            <x-admin.shared.copy-product-modal product-type="gach-trang-tri-ct" :copied-product="$copiedProduct ?? null" />
        </div>
        <form method="POST" action="{{ route('admin.gach-trang-tri-ct.store') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Giá (VNĐ) <span
                                    class="text-red-500">*</span></label>
                    ...
                    <div class="bg-gray-50/80 rounded-xl border border-gray-200 p-5">
                        <div class="flex items-center justify-between mb-4 border-b border-gray-200 pb-3">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Mỗi khối tương ứng với 1 gạch đầu dòng (bullet
                                    point) trên Website.</p>
                            </div>
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.gach-trang-tri-ct.index') }}"
                    class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Hủy</a>
                <button type="submit"
    ...
    @push('scripts')
        ...
        function addDesBlock(value = '') {
            ...
            // Tự động focus vào input vừa tạo
            if(value === '') {

<x-admin.layouts.app title="ThÃªm Gáº¡ch Trang TrÃ­" breadcrumb="Admin â€º DS Sáº£n pháº©m chi tiáº¿t â€º ThÃªm má»›i">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.gach-trang-tri-ct.store') }}" enctype="multipart/form-data"
            class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">TÃªn sáº£n pháº©m <span
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">MÃ£ sáº£n pháº©m (Code) <span
                                    class="text-red-500">*</span></label>
                            <input type="text" name="code" value="{{ old('code') }}" required
                                class="w-full px-4 py-2.5 text-sm border rounded-lg border-gray-300 focus:border-[#A31D1D] focus:ring-1 focus:ring-[#A31D1D] outline-none transition-all"
                                placeholder="VD: NAD-001">
                            @error('code')
                                <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">GiÃ¡ (VNÄ) <span
                                    class="text-red-500">*</span></label>
                        ...
                        <div>
                            ...
                            <input type="text" name="size" value="{{ old('size') }}"
                                placeholder="VD: L200 x W200 x D20 mm"
                                class="w-full px-4 py-2.5 text-sm border rounded-lg border-gray-300 focus:border-[#A31D1D] focus:ring-1 focus:ring-[#A31D1D] outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div class="bg-gray-50/80 rounded-xl border border-gray-200 p-5">
                        <div class="flex items-center justify-between mb-4 border-b border-gray-200 pb-3">
                            <div>
                                ...
                                <p class="text-xs text-gray-500 mt-0.5">Má»—i khá»‘i tÆ°Æ¡ng á»©ng vá»›i 1 gáº¡ch Ä‘áº§u dÃ²ng (bullet
                                    point) trÃªn Website.</p>
                            </div>
                            <button type="button" onclick="addDesBlock()"
                                class="px-4 py-2 bg-white border border-gray-300 text-gray-700 text-xs font-bold rounded-lg hover:bg-gray-50 hover:text-[#A31D1D] hover:border-[#A31D1D] transition-colors shadow-sm flex items-center gap-1.5">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div
                        ...
                        <div
                            ...
                            <span class="text-white text-xs font-medium px-3 py-1.5 bg-black/50 rounded-lg">Táº£i áº£nh
                                lÃªn</span>
                        </div>
                        <input type="file" name="size_image" accept="image/*"
                            onchange="previewImage(event, 'preview-size')"
            ...
            <!-- CHá»ŒN áº¢NH Sáº¢N PHáº¨M (MULTIPLE) -->
            <hr class="border-gray-100 my-8">
            <div class="flex flex-col h-full border border-gray-200 rounded-xl p-6 bg-gray-50/50">
                <label class="block text-sm font-semibold text-gray-700 mb-2">HÃ¬nh áº£nh sáº£n pháº©m <span
                        class="text-red-500">*</span></label>
                <p class="text-xs text-gray-500 mb-4">Chá»n 1 hoáº·c nhiá»u áº£nh chi tiáº¿t cá»§a sáº£n pháº©m (áº¢nh Ä‘áº§u tiÃªn sáº½ lÃ m
                    áº£nh bÃ¬a).</p>
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.gach-trang-tri-ct.index') }}"
                    class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Há»§y</a>
                <button type="submit"
    ...
    @push('scripts')
        ...
        function addDesBlock(value = '') {
            ...
            // Tá»± Ä‘á»™ng focus vÃ o input vá»«a táº¡o
            if(value === '') {

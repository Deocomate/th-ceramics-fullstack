...
<x-admin.layouts.app title="Cáº­p nháº­t Gáº¡ch Trang TrÃ­" breadcrumb="Admin â€º DS Sáº£n pháº©m chi tiáº¿t â€º Chá»‰nh sá»­a">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.gach-trang-tri-ct.update', $product->gach_trang_tri_ct_id) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.gach-trang-tri-ct.index') }}" class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Há»§y bá»</a>
    ...
    <script>
        ...
        // Khá»Ÿi táº¡o cÃ¡c block cÅ© tá»« Database (CÃ³ logic tÆ°Æ¡ng thÃ­ch ngÆ°á»£c)

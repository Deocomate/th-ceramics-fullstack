...
<x-admin.layouts.app title="C?p nh?t Ngói Hài C?" breadcrumb="Admin › DS S?n ph?m chi ti?t › Ch?nh s?a">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.ngoi-hai-co-ct.update', $product->ngoi_hai_co_ct_id) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 space-y-5">
                    ...
                    <div class="bg-gray-50/80 rounded-xl border border-gray-200 p-5">
                        ...
                        @error('des.*') <p class="mt-2 text-xs text-red-600">M?t trong các dòng mô t? b? l?i, vui lòng ki?m tra l?i d? dài.</p> @enderror
                    </div>
                </div>
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.ngoi-hai-co-ct.index') }}" class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">H?y b?</a>

        ...
        <form method="POST" action="{{ route('admin.gach-hoa-thong-gio.update') }}" enctype="multipart/form-data"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <label for="video" class="block text-sm font-semibold text-gray-700 mb-2">Đường dẫn Video
                            YouTube (Tùy chọn)</label>
                        <div class="relative">
                ...
                <div class="flex flex-col h-full border border-gray-200 rounded-xl p-4 bg-gray-50/50">
                    <label class="block text-sm font-semibold text-gray-700 mb-2">Thư viện ảnh (Chọn nhiều ảnh cùng
                        lúc)</label>
                    <p class="text-xs text-gray-500 mb-4">Các ảnh này sẽ được thêm vào thư viện sản phẩm khi bạn lưu.
                    </p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8 px-4 lg:px-16">
                @foreach($gachHoaThongGio->giaTri as $giaTri)
                    <div class="group relative flex flex-col items-center bg-[#F3EFEA] rounded-xl border border-gray-200 overflow-hidden pb-8 hover:shadow-xl transition-all duration-300">
                        ...
                        <!-- Khu vực Hình ảnh xếp lớp -->
                        <!-- Thêm pb-12 để bù lại phần ảnh lồi xuống không bị đè vào chữ -->
                        <div class="w-full flex justify-center pt-10 pb-12">
                            <!-- Giảm w-[75%] xuống w-[65%] để cụm ảnh gọn gàng hơn -->
                            <div class="relative w-[65%] aspect-[10/9]">
                                <!-- Background (Hình nền phía sau) -->
                                ...
                                <!-- Image (Hình ảnh nổi phía trước lồi xuống dưới) -->
                        ...
                        <!-- Overlay chứa Nút Sửa / Xóa khi Hover -->
    ...
    @push('scripts')
        <script>
            ...
            function handleMultipleFiles(event) {
                ...
                if (files.length > 0) {
                    // Thêm file mới vào mảng đã chọn
            ...
            function renderPreviews() {
                // Xóa tất cả các preview hiện tại (không xóa phần empty-state)
            ...
            function removeFile(index) {
                ...
                // Cập nhật lại input và giao diện
                updateFileInput();
                renderPreviews();
            }

            function updateFileInput() {
                // Sử dụng DataTransfer để gán lại danh sách file cho thẻ <input type="file">

<x-admin.layouts.app title="Định Mức Ngói Hài Văn Miếu" breadcrumb="Admin › DS Sản phẩm chi tiết › Ngói Hài Văn Miếu › Định Mức">
    ...
    <div class="mb-8 p-6 bg-blue-50/40 rounded-xl border border-blue-100 shadow-[0_0_15px_rgba(59,130,246,0.03)] relative overflow-hidden">
        ...
        <form action="{{ route('admin.dinh-muc-ngoi-hai-van-mieu.store') }}" method="POST">
            @csrf
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <button type="button" title="Sửa định mức"
                                        ...
                                        onclick="openEditModal(this, '{{ route('admin.dinh-muc-ngoi-hai-van-mieu.update', $item->dinh_muc_ngoi_hai_van_mieu_id) }}')" 
                                        class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                    </button>
                                    <button type="button" title="Xóa định mức"
                                        onclick="openDeleteModal('{{ route('admin.dinh-muc-ngoi-hai-van-mieu.destroy', $item->dinh_muc_ngoi_hai_van_mieu_id) }}')" 

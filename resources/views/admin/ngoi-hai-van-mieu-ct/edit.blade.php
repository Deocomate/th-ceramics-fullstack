...
<x-admin.layouts.app title="Cáº­p nháº­t NgÃ³i HÃ i VÄƒn Miáº¿u" breadcrumb="Admin â€º DS Sáº£n pháº©m chi tiáº¿t â€º Chá»‰nh sá»­a">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.ngoi-hai-van-mieu-ct.update', $product->ngoi_hai_van_mieu_ct_id) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.ngoi-hai-van-mieu-ct.index') }}" class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Há»§y bá»</a>
    ...
    <div id="deleteImageModal" class="fixed inset-0 z-[100] hidden items-center justify-center bg-black/60 backdrop-blur-sm px-4 opacity-0 transition-opacity duration-300">
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden transform scale-95 transition-transform duration-300 p-6 text-center">
            ...
            <div class="flex justify-center gap-3">
                ...
                <form id="deleteImageForm" method="POST" action="{{ route('admin.ngoi-hai-van-mieu-ct.image.destroy', $product->ngoi_hai_van_mieu_ct_id) }}" class="flex-1">
                    @csrf @method('DELETE')

<x-admin.layouts.app title="ThÃªm NgÃ³i HÃ i VÄƒn Miáº¿u" breadcrumb="Admin â€º DS Sáº£n pháº©m chi tiáº¿t â€º ThÃªm má»›i">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.ngoi-hai-van-mieu-ct.store') }}" enctype="multipart/form-data" class="p-6">
                ...
                <div class="lg:col-span-2 space-y-5">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="name" value="{{ old('name') }}" required placeholder="VD: NgÃ³i HÃ i VÄƒn Miáº¿u Cá»¡ Nhá»" 
            ...
            <div class="flex flex-col h-full border rounded-xl p-6 bg-gray-50/50 {{ $errors->has('images') ? 'border-red-300 bg-red-50/30' : 'border-gray-200' }}">
                ...
                <p class="text-xs text-gray-500 mb-4">Chá»n 1 hoáº·c nhiá»u áº£nh chi tiáº¿t chung cá»§a sáº£n pháº©m (HÃ¬nh há»c, gÃ³c cáº¡nh...). MÃ u sáº¯c sáº½ Ä‘Æ°á»£c quáº£n lÃ½ á»Ÿ pháº§n Biáº¿n Thá»ƒ.</p>
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.ngoi-hai-van-mieu-ct.index') }}" class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">Há»§y</a>
    ...
    <script>
        ...
        // Populate from old() - Sá»­a lá»—i máº¥t Data khi reload

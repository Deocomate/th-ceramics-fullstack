...
<x-admin.layouts.app title="C?p nh?t Ngói Âm Duong" breadcrumb="Admin › DS S?n ph?m chi ti?t › Ch?nh s?a">
    ...
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.ngoi-am-duong-ct.update', $product->ngoi_am_duong_ct_id) }}" enctype="multipart/form-data" class="p-6">
            ...
            <div class="pt-6 mt-8 flex justify-end gap-3 border-t border-gray-100">
                <a href="{{ route('admin.ngoi-am-duong-ct.index') }}" class="px-6 py-2.5 text-sm font-semibold text-gray-600 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">H?y b?</a>

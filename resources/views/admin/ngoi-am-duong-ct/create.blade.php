<x-admin.layout.app title="Thêm Ngói Âm Dương" breadcrumb="Admin › DS Sản phẩm chi tiết › Thêm mới">
    <div class="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden mb-8">
        ...
        <form method="POST" action="{{ route('admin.ngoi-am-duong-ct.store') }}" enctype="multipart/form-data"
            class="p-6">
            @csrf

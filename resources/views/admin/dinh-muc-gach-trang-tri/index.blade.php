<x-admin.layout.app title="Định Mức Gạch Trang Trí" breadcrumb="Admin › DS Sản phẩm chi tiết › Gạch Trang Trí › Định Mức">
    ...
    <div class="mb-8 p-6 bg-blue-50/30 rounded-xl border border-blue-100 shadow-sm">
        ...
        <form action="{{ route('admin.dinh-muc-gach-trang-tri.store') }}" method="POST">
            @csrf
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-5 items-end">
                <div class="md:col-span-2 lg:col-span-2">
                    ...
                    <input type="text" name="brick_type" required placeholder="VD: Gạch Trang Trí Vuông" class="w-full px-3 py-2.5 text-sm border rounded-lg border-gray-300 focus:border-[#A31D1D] outline-none">
                </div>
                <div>
                            ...
                            <td class="px-6 py-4 text-right">
                                <div class="flex justify-end gap-2">
                                    <button type="button" 
                                        ...
                                        onclick="openEditModal(this, '{{ route('admin.dinh-muc-gach-trang-tri.update', $item->dinh_muc_gach_trang_tri_id) }}')" 
                                        class="p-2 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/></svg>
                                    </button>
                                    <button type="button" 
                                        onclick="openDeleteModal('{{ route('admin.dinh-muc-gach-trang-tri.destroy', $item->dinh_muc_gach_trang_tri_id) }}')" 

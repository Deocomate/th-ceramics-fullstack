                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="3"
                                  class="w-full px-4 py-2.5 text-sm border rounded-lg focus:border-[#A31D1D] outline-none">{{ old('description', $coupon->description) }}</textarea>
                    ...
                    <div>
                        ...
                        <input type="number" name="discount_value" value="{{ old('discount_value', $coupon->discount_value) }}" required
                               step="0.01" min="0.01"
                               class="w-full px-4 py-2.5 text-sm border rounded-lg focus:border-[#A31D1D] outline-none">
                            ...
                            @foreach($productTypes as $type => $label)
                                <label class="flex items-center gap-2 cursor-pointer text-sm">
                                    <input type="checkbox" name="applicable_product_types[]" value="{{ $type }}"
                                           {{ in_array($type, old('applicable_product_types', $coupon->applicable_product_types ?? [])) ? 'checked' : '' }}
                    ...
                    <div class="space-y-3 pt-2 border-t border-gray-100">
                        <label class="flex items-center gap-3 cursor-pointer">
                            ...
                            <input type="checkbox" name="show_banner" value="1"
                                   {{ old('show_banner', $coupon->show_banner) ? 'checked' : '' }}
                                   class="w-4 h-4 text-[#A31D1D] focus:ring-[#A31D1D] rounded">

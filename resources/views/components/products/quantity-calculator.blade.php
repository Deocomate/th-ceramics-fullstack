    ...
    const addArea = () => {
      ...
      if (!removeBtn) {
        ...
        if (header) {
          ...
          button.type = "button";
          button.setAttribute("data-remove-area", "");
          button.className = "text-[14px] text-secondary underline text-start ml-4 font-medium opacity-80 hover:opacity-100 transition-opacity";
          button.textContent = "Loại bỏ";

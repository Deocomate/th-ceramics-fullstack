  ...
  <div class="w-[85%] max-w-[1320px] mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 lg:gap-32 items-start mt-0">
      <div class="flex flex-col items-center">
        <h2 class="text-[20px] md:text-3xl font-semibold text-[#C76E00] md:text-secondary mb-6 md:mb-12 uppercase text-center md:tracking-normal">KÃCH THÆ¯á»šC</h2>
        <div class="w-full max-w-[500px] flex justify-center">
          <img src="{{ isset($image) ? $image : asset('assets/images/gtt-size.png') }}" alt="KÃ­ch thÆ°á»›c sáº£n pháº©m" class="w-full h-auto object-contain px-4 md:px-0" />
        </div>
      </div>

      <div class="flex flex-col mt-4 md:mt-0">
        <h2 class="text-[20px] md:text-3xl font-semibold text-[#C76E00] md:text-secondary mb-8 md:mb-12 uppercase text-center lg:text-center md:tracking-normal w-[85%] mx-auto md:w-full">CÃCH TÃNH KHá»I LÆ¯á»¢NG</h2>
        ...
        <div class="space-y-4 md:space-y-6 w-[90%] md:w-full mx-auto md:mx-0">
          <div class="flex flex-row md:flex-row gap-4 md:gap-6 items-end justify-center md:justify-start" data-area-block>
            <div class="w-[111px] md:w-[120px] shrink-0 pb-2 md:pb-1 text-left">
              <span class="font-semibold text-[#2E2F2A] md:text-primary uppercase text-[11px] md:text-base">DIá»†N TÃCH 1</span>
            </div>
            <div class="flex-1 max-w-[250px] md:max-w-none w-full grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-6 items-end">
              ...
              <div class="flex flex-col gap-1 md:gap-2 md:col-span-2">
                <label class="text-[9px] md:text-[16px] uppercase font-semibold text-[#2E2F2A] md:text-primary text-center md:mb-2 leading-[24px] md:leading-normal">CHIá»€U DÃ€I</label>
                <div class="relative">
              ...
              <div class="flex flex-col gap-1 md:gap-2 md:col-span-2">
                <label class="text-[9px] md:text-[16px] uppercase font-semibold text-[#2E2F2A] md:text-primary text-center md:mb-2 leading-[24px] md:leading-normal">CHIá»€U Rá»˜NG</label>
                <div class="relative">
                  <input type="number" step="0.01" min="0" placeholder="00" class="w-full h-[30px] md:h-[45px] p-2 md:p-3 text-[12px] md:text-base border border-[#DDD6D0] md:border-black/10 rounded-[1px] md:rounded-sm bg-transparent text-left pr-6 md:pr-8 focus:border-secondary outline-none transition-colors text-[#2E2F2A] md:text-primary placeholder:text-[#9CA3AF]" />
                  <span class="absolute right-2 md:right-3 top-1/2 -translate-y-1/2 text-[10px] md:text-[12px] text-black/40 md:text-primary/40 leading-[15px]">m</span>
                </div>
          ...
          <div class="flex flex-row md:flex-row gap-4 md:gap-6 items-end justify-center md:justify-start" data-area-block>
            <div class="w-[111px] md:w-[120px] shrink-0 pb-2 md:pb-1 flex flex-row gap-2 md:gap-0 md:flex-col items-start md:mt-2">
              <span class="font-semibold text-[#2E2F2A] md:text-primary uppercase text-[11px] md:text-base">DIá»†N TÃCH 2</span>
              <button data-remove-area class="text-[8px] md:text-[14px] text-[#C76E00]/70 md:text-secondary underline text-start font-normal md:font-medium opacity-80 hover:opacity-100 transition-opacity mt-0.5 md:mt-0 italic md:not-italic">Loáº¡i bá»</button>
            </div>
            <div class="flex-1 max-w-[250px] md:max-w-none w-full grid grid-cols-2 md:grid-cols-5 gap-3 md:gap-6 items-end">
              <hr class="hidden md:block md:col-span-1" />
          ...
          <div class="text-center w-full pt-1">
            <button data-add-area class="text-[#C76E00] md:text-secondary font-semibold text-[10px] md:text-sm underline hover:opacity-80 transition-opacity leading-[20px]">+ ThÃªm diá»‡n tÃ­ch</button>
          </div>

          <div class="w-full pt-4 md:pt-0 pb-6 md:pb-0">
            <button data-calculate-quantity class="w-full py-[16px] md:py-4 bg-[#C16A00] hover:bg-secondary text-white text-[14px] font-bold uppercase tracking-[0.42px] md:tracking-widest rounded-[2px] md:rounded-sm shadow-[0_4px_6px_-1px_rgba(0,0,0,0.1),0_2px_4px_-2px_rgba(0,0,0,0.1)] transition-all duration-300 leading-[20px]">TÃNH TOÃN KHá»I LÆ¯á»¢NG</button>
          </div>
            ...
            <div class="flex flex-col md:grid md:grid-cols-5 gap-y-2 md:gap-y-4 items-start w-full">
              <div class="flex justify-between items-center w-full md:contents">
                <div class="md:col-span-4">
                  <h4 class="font-semibold text-[#2E2F2A] md:text-primary uppercase text-[16px] md:text-xl leading-[28px] md:leading-normal">Káº¾T QUáº¢</h4>
                </div>
                <div class="text-right">
                  <span data-total-area-output class="text-[16px] md:text-2xl font-bold text-[#2E2F2A] md:text-primary leading-[20px] md:leading-none">{{ isset($totalArea) ? $totalArea : '00' }} mÂ²</span>
                </div>
              </div>
              ...
              <div class="flex flex-row items-end justify-start w-full md:contents pt-1 md:pt-0 relative">
                <div class="md:col-span-3 pr-2 md:pr-0">
                  <p class="text-[12px] md:text-[14px] italic text-[#2E2F2A] md:text-primary font-light md:font-light leading-[18px] max-w-[132px] md:max-w-none">
                    {{ isset($areaNote) ? $areaNote : 'Diá»‡n tÃ­ch Ä‘Æ°á»£c lÃ m trÃ²n lÃªn Ä‘áº¿n mÂ² gáº§n nháº¥t.' }}
                  </p>
                </div>
                <div class="text-center md:col-span-1 px-2 md:px-0 flex flex-col justify-end">
                  <span class="text-[14px] md:text-base font-bold text-[#2E2F2A] md:text-primary tracking-[0.80px] md:tracking-wider leading-[24px]">Äá»‹nh má»©c</span>
                </div>
              ...
              <div class="flex justify-between items-center w-full md:contents">
                <div class="md:col-span-3 py-1 text-left w-[40%] md:w-auto">
                  <span class="text-[#2E2F2A] md:text-primary text-[16px] md:text-base leading-[24px]">{{ isset($label1) ? $label1 : 'Gáº¡ch' }}</span>
                </div>
                <div class="text-center py-1 w-[30%] md:w-auto">
                  <span data-rate-output class="text-[#2E2F2A] md:text-primary text-[14px] md:text-base leading-[16px]">{{ isset($rate1) ? $rate1 : '-- viÃªn/mÂ²' }}</span>
                </div>
                <div class="text-right py-1 w-[30%] md:w-auto flex justify-end">
                  <span data-value-output class="text-[#2E2F2A] md:text-primary font-bold text-[14px] md:text-base leading-[16px]">{{ isset($value1) ? $value1 : '00 viÃªn' }}</span>
                </div>
              </div>
              ...
              <div class="flex justify-between items-center w-full md:contents border-t border-black/5 md:border-none pt-2 md:pt-0 mt-2 md:mt-0">
                <div class="md:col-span-3 py-1 text-left w-[35%] md:w-auto">
                  <span class="text-[#2E2F2A] md:text-primary text-[16px] md:text-base leading-[24px]">{{ isset($label2) ? $label2 : 'Gáº¡ch' }}</span>
                </div>
                <div class="text-center py-1 w-[30%] md:w-auto">
                  <span data-rate-output class="text-[#2E2F2A] md:text-primary text-[14px] md:text-base leading-[16px]">{{ isset($rate2) ? $rate2 : '-- viÃªn/mÂ²' }}</span>
                </div>
                <div class="text-right py-1 w-[35%] md:w-auto flex justify-end">
                  <span data-value-output class="text-[#2E2F2A] md:text-primary font-bold text-[14px] md:text-base leading-[16px]">{{ isset($value2) ? $value2 : '00 viÃªn' }}</span>
                </div>
              </div>
              @endisset
              ...
              <div class="w-full md:col-span-5 pt-1 md:pt-0">
                <p class="text-[12px] italic text-[#2E2F2A] md:text-primary/80 leading-[18px]">
                  {{ isset($areaNote) ? $areaNote : 'Diá»‡n tÃ­ch Ä‘Æ°á»£c lÃ m trÃ²n <br class="md:hidden"> lÃªn Ä‘áº¿n mÂ² gáº§n nháº¥t.' }}
                </p>
              </div>
              @endisset
            </div>
          ...
          <div class="space-y-4 pt-4 border-t border-black/10 border-solid mt-2 md:mt-0">
            ...
            >
              ...
              <span class="flex items-center gap-2">
                <span class="text-[15px] text-[#2E2F2A]/80 font-medium md:text-primary/80 leading-[22.5px]">Cá»™ng thÃªm hao há»¥t</span>
            ...
            <div class="pl-8 space-y-3 hidden peer-checked:block">
              <label class="flex items-center gap-3 cursor-pointer group">
                ...
                <span class="text-[14px] text-[#2E2F2A] md:text-primary/70 font-medium md:font-medium tracking-tight">ThÃªm 5%</span>
              </label>
              <label class="flex items-center gap-3 cursor-pointer group">
                <div class="relative flex items-center justify-center">
                ...
                <span class="text-[14px] text-[#2E2F2A] md:text-primary/70 font-medium tracking-tight">ThÃªm 10% (Äá»‘i vá»›i gáº¡ch dá»‹ hÃ¬nh)</span>
              </label>
            </div>
          </div>
        </div>

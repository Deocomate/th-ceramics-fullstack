...
<footer class="bg-[#262723] text-white font-archivo">
  ...
  <div class="relative bg-[#262723] overflow-hidden">
    <div
      ...
      style="
        background-image: url('{{ asset('assets/images/footer-image-2.png') }}');
        background-size: 1600px 448px;
    ...
    ></div>
    <div
      class="absolute inset-0 bg-black/10 md:bg-black/20"
      aria-hidden="true"
    ></div>
    ...
    >
      ...
      >
        <div
          class="flex flex-col items-start sm:items-center gap-6 md:gap-10 lg:gap-[44px] min-w-0"
        >
          <div>
            <img
        ...
        <div
          class="min-w-0 sm:col-span-1 md:col-span-1"
        >
          <div
            class="text-white text-[15px] leading-[26px] mb-7 lg:mb-[27px]"
          >
        ...
        >
          <h3
            class="text-white text-base font-semibold leading-[26px] mb-4 uppercase break-words"
          >
            TỔNG QUAN
          </h3>
          <div class="flex flex-col gap-3 lg:gap-[14px] text-[15px] lg:text-base leading-[26px]">
            <a
              ...
              class="text-white font-normal break-words hover:text-secondary transition-colors"
              >Về chúng tôi</a>
            <a
        ...
        >
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-8 gap-y-3 lg:gap-x-[50px]">
            <div
              class="flex flex-col gap-3 lg:gap-[14px] text-[15px] lg:text-base leading-[26px] min-w-0"
            >
              <a
        ...
        >
          <h3
            class="text-white text-base font-semibold leading-[26px] mb-4 uppercase whitespace-nowrap"
          >
            DỊCH VỤ KHÁCH HÀNG
          </h3>
          <div class="flex flex-col gap-3 lg:gap-[14px] text-[15px] lg:text-base leading-[26px]">
    ...
    <div class="relative border-t border-white/20 w-full">
      <div class="w-full max-w-[1320px] mx-auto px-6 sm:px-8 xl:px-0 py-5 xl:py-[14px]">
        <div
          class="flex flex-col-reverse md:flex-row justify-between items-center gap-3 md:gap-6"
        >
          <p
            class="text-[#909090] text-sm leading-[26px] text-center md:text-left font-normal"
            style="font-family: Inter, Archivo, sans-serif;"
          >
            Copyright &copy; 2022 . All rights reserved
          </p>
          <div
            class="text-[#909090] text-sm leading-[26px] flex items-center justify-center flex-wrap gap-y-1 font-normal text-center md:text-right"
            style="font-family: Inter, Archivo, sans-serif;"
          >
            <a

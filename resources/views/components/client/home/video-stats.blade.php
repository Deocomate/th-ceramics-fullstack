...
<section class="bg-primary text-white py-8 lg:py-20">
    <div class="w-[85%] max-w-[1320px] mx-auto">
        ...
        <div class="relative w-full aspect-video mb-8 lg:mb-10 rounded-lg lg:rounded-none overflow-hidden cursor-pointer group"
            data-aos="fade-up" data-aos-delay="200"
            @if ($trangChu?->video) data-video-url="{{ $trangChu->video }}" role="button" tabindex="0" @endif>
            <img src="{{ asset('assets/images/video-placeholder.jpg') }}" alt="Video placeholder"
                class="w-full h-full object-cover brightness-50 group-hover:brightness-[0.4] transition-all duration-300" />
            <div class="absolute inset-0 flex items-center justify-center">
                <!-- Mobile Play Button -->
                <div
                    class="lg:hidden w-16 h-16 bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center group-hover:bg-white/50 transition-all duration-300">
                    <svg class="w-8 h-8 text-white ml-1" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M8 5v14l11-7z"></path>
                    </svg>
                </div>
                <!-- Desktop Play Button -->
                <img src="{{ asset('assets/images/play-video-button.svg') }}" alt="Play video"
                    ...
                    const getYoutubeId = (url) => {
                        ...
                        try {
                            ...
                            if (host === "youtube.com" || host === "m.youtube.com") {
                                ...
                                const embedIndex = pathParts.findIndex((part) => ["embed", "shorts", "v"].includes(part), );
    ...
    <div id="youtube-video-modal"
        ...
        aria-hidden="true">
        <button id="close-video-modal" type="button"
        ...
        <div class="relative w-full max-w-5xl aspect-video overflow-hidden rounded-lg shadow-2xl">
            <iframe id="youtube-iframe" class="w-full h-full" src="" title="TH Ceramics video" frameborder="0"

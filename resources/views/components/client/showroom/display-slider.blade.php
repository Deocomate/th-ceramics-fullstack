...
<section
  class="w-full max-w-[1920px] px-6 lg:px-[8%] 2xl:pr-[12.5%] mx-auto pb-16 lg:pb-32 lg:pt-8 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-10 xl:gap-20 items-center overflow-hidden text-white"
>
  <!-- Left: Slider Image -->
  <div
  ...
  <!-- Right: Text Info -->
  <div
    class="lg:col-span-5 flex flex-col gap-6 relative z-10 order-1 lg:order-2 justify-self-end text-white"
    data-aos="fade-left"
  >
    <h2 class="font-arima text-3xl md:text-4xl lg:text-[48px] font-medium leading-[1.2] text-white">Phòng trưng bày</h2>
    ...
    <div class="w-[85%] md:w-full mx-auto md:mx-0 flex flex-col gap-5 text-xs mb-8 text-white">
      <div class="grid grid-cols-[100px_1fr] md:grid-cols-[100px_1fr] gap-4 items-start">
        ...
        <span class="font-semibold text-sm leading-snug w-full max-w-[320px] text-white">{{ $showroomContent ?? '10 ngõ 252 - Thôn 3, Giang Cao, Bát Tràng, Hà Nội' }}</span>
      </div>

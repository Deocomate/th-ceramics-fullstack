...
@if ($ngoiBoNocProducts->isNotEmpty())
    ...
    <section class="w-full md:pb-16 pt-2 md:pt-8">
        <div class="flex items-center justify-center gap-4 md:gap-5 md:mb-10 max-w-[315px] md:max-w-full mx-auto"
            data-aos="fade-up">
            <img src="{{ asset('assets/images/title-left.svg') }}" alt=""
            ...
            <img src="{{ asset('assets/images/title-right.svg') }}" alt=""
                class="h-16 md:h-20 lg:h-[110px] drop-shadow-sm opacity-25 scale-[60%] md:scale-100">
        </div>

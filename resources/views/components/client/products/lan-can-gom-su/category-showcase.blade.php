      ...
      <div class="w-full lg:w-[55%] flex flex-col justify-between">
        <div class="grid grid-cols-2 gap-x-4 md:gap-x-8 lg:gap-x-16 gap-y-6 md:gap-y-10 lg:gap-y-12 mb-6 md:mb-10">
          <x-client.shared.product-card
            href="#"
            image="{{ asset('assets/images/lan-can-02.jpg') }}"
            ...
            code="MSP: 1234RDS"
            price="Giá: 675.000 đ/m2"
            :show-overlay="true"
          />

          <x-client.shared.product-card
            href="#"
            image="{{ asset('assets/images/lan-can-04.jpg') }}"
            title="Riềm Âm Dương Sen Bầu"
            title-class="font-bold text-[#212121] text-[14px] lg:text-[15px] uppercase mb-1 tracking-wide transition-colors group-hover:text-secondary"
            code="MSP: 1234RDS"
            price="Giá: 675.000 đ/m2"
          ...
          <x-client.shared.product-card
            href="#"
            image="{{ asset('assets/images/lan-can-05.jpg') }}"
            title="Riềm Âm Dương Sen Bầu"
            title-class="font-bold text-[#212121] text-[14px] lg:text-[15px] uppercase mb-1 tracking-wide transition-colors group-hover:text-secondary"
            code="MSP: 1234RDS"
            price="Giá: 675.000 đ/m2"
          ...
          <x-client.shared.product-card
            href="#"
            image="{{ asset('assets/images/lan-can-06.jpg') }}"
            title="Riềm Âm Dương Sen Bầu"
            title-class="font-bold text-[#212121] text-[14px] lg:text-[15px] uppercase mb-1 tracking-wide transition-colors group-hover:text-secondary"
            code="MSP: 1234RDS"
            price="Giá: 675.000 đ/m2"

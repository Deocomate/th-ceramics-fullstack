<aside class="fixed inset-y-0 left-0 z-40 w-64 flex flex-col bg-[#0f0f13]">
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-4 space-y-0.5">
        ...
        @php
            $isProductDetail = request()->routeIs([
            ...
            <div id="submenu-product-detail"
                ...
                <div class="overflow-hidden">
                    <div class="pl-7 pr-3 space-y-3 pb-2 pt-1">
                        <!-- Nhóm Ngói Âm Dương -->
                        <div class="space-y-1">
                            <p class="px-2 text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1">Ngói Âm
                                Dương</p>
                            <a href="{{ route('admin.ngoi-am-duong-ct.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs('admin.ngoi-am-duong-ct.*') ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Danh sách sản phẩm
                            </a>
                            <a href="{{ route('admin.mau-sac-ngoi-am-duong-ct.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs('admin.mau-sac-ngoi-am-duong-ct.*') ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Quản lý màu sắc
                            </a>
                            <a href="{{ route('admin.dinh-muc-ngoi-am-duong.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs('admin.dinh-muc-ngoi-am-duong.*') ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Quản lý định mức
                            </a>
                        </div>
                        ...
                        <!-- Nhóm Ngói Hài Cổ -->
                        <div class="space-y-1">
                            <p class="px-2 text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1">Ngói Hài
                                Cổ</p>

                            <a href="{{ route('admin.ngoi-hai-co-ct.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs(['admin.ngoi-hai-co-ct.*', 'admin.mau-sac-ngoi-hai-co-ct.*']) ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Danh sách sản phẩm
                            </a>
                        ...
                        <!-- Nhóm Gạch Hoa Thông Gió -->
                        <div class="space-y-1">
                            <p class="px-2 text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1 mt-3">Gạch Hoa Thông Gió</p>
                            <a href="{{ route('admin.gach-hoa-thong-gio-ct.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs('admin.gach-hoa-thong-gio-ct.*') ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Danh sách sản phẩm
                            </a>
                        ...
                        <!-- Nhóm Gạch Cổ Bát Tràng -->
                        <div class="space-y-1">
                            <p class="px-2 text-[11px] font-bold text-gray-500 uppercase tracking-wider mb-1 mt-3">Gạch Cổ Bát Tràng</p>
                            <a href="{{ route('admin.gach-co-bat-trang-ct.index') }}"
                                class="block px-3 py-2 rounded-lg text-[13px] font-medium transition-all duration-200 {{ request()->routeIs('admin.gach-co-bat-trang-ct.*') ? 'text-white bg-white/[0.08]' : 'text-gray-400 hover:text-gray-200 hover:bg-white/[0.02]' }}">
                                Danh sách sản phẩm
                            </a>

...
<head>
    ...
    <title>{{ $title ?? 'Admin' }} — TH Ceramics</title>
...
<body class="h-full" style="background:#F3F6F9;">
    ...
    <div class="flex h-full min-h-screen">
        ...
        <div class="flex-1 flex flex-col min-h-screen" style="margin-left:16rem;">
            ...
            {{-- Top Header --}}
            <header
                class="sticky top-0 z-30 bg-white border-b border-gray-200 px-6 py-4 flex items-center justify-between">
                <div>
            ...
            @if (session('success'))
                <div
                    class="mx-6 mt-4 flex items-center gap-3 px-4 py-3 rounded text-sm text-green-800 bg-green-50 border border-green-200">
            ...
            @if (session('error'))
                <div
                    class="mx-6 mt-4 flex items-center gap-3 px-4 py-3 rounded text-sm text-red-800 bg-red-50 border border-red-200">

...
class FactoryPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'intro_description' => ['nullable', 'array'],
            'intro_description.*.type' => ['required', 'string', 'in:paragraph,list'],
            'intro_description.*.content' => ['nullable', 'string'],
            'intro_description.*.items' => ['nullable', 'array'],
            'intro_description.*.items.*.title' => ['nullable', 'string', 'max:500'],
            'intro_description.*.items.*.content' => ['nullable', 'string'],
            'process_title' => ['nullable', 'string', 'max:500'],
            'process_description' => ['nullable', 'array'],
            'process_description.*.type' => ['required', 'string', 'in:paragraph,list'],
            'process_description.*.content' => ['nullable', 'string'],
            'process_description.*.items' => ['nullable', 'array'],
            'process_description.*.items.*.title' => ['nullable', 'string', 'max:500'],
            'process_description.*.items.*.content' => ['nullable', 'string'],
            'process_bottom_title' => ['nullable', 'string', 'max:500'],
            'process_bottom_desc' => ['nullable', 'array'],
            'process_bottom_desc.*.type' => ['required', 'string', 'in:paragraph,list'],
            'process_bottom_desc.*.content' => ['nullable', 'string'],
            'process_bottom_desc.*.items' => ['nullable', 'array'],
            'process_bottom_desc.*.items.*.title' => ['nullable', 'string', 'max:500'],
            'process_bottom_desc.*.items.*.content' => ['nullable', 'string'],
            ...
            'new_gallery_2' => ['nullable', 'array'],
            'new_gallery_2.*' => ['image', 'mimes:jpg,jpeg,png,webp', 'max:5120'],
            'delete_gallery_2' => ['nullable', 'array'],
            'delete_gallery_2.*' => ['integer'],
    ...
    public function messages(): array
    {
        return [
            ...
            'new_gallery_2.*.image' => 'Mỗi file trong thư viện ảnh 2 phải là hình ảnh.',
            'new_gallery_2.*.max' => 'Mỗi file trong thư viện ảnh 2 không được vượt quá 5MB.',

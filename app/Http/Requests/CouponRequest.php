...
class CouponRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'applicable_product_types.*' => ['string', 'in:ngoi_am_duong_ct,ngoi_hai_van_mieu_ct,ngoi_hai_co_ct,gach_hoa_thong_gio_ct,gach_trang_tri_ct,gach_co_bat_trang_ct,linh_vat_phong_thuy_ct,lan_can_gom_xu,den_gom_su,den_vuon_gom_su_ct,phu_kien_ngoi'],

...
class MauSacNgoiHaiVanMieuCtService
{
    ...
    {
        $query = MauSacNgoiHaiVanMieuCt::query()->with('product')->latest();
        ...
        if ($productId) {
            $query->where('ngoi_hai_van_mieu_ct_id', $productId);
        }
    ...
    public function create(array $data)
    {
        ...
        if (isset($data['image']) && $data['image'] instanceof UploadedFile) {
            $fillable['image'] = FileUploadHelper::upload($data['image'], 'mau_sac_ngoi_hai_van_mieu_ct/images');
        }

        return MauSacNgoiHaiVanMieuCt::query()->create($fillable);
    }
    ...
    public function update(int $id, array $data)
    {
        ...
        if (isset($data['image']) && $data['image'] instanceof UploadedFile) {
            $fillable['image'] = FileUploadHelper::replace($data['image'], $model->image, 'mau_sac_ngoi_hai_van_mieu_ct/images');
        }

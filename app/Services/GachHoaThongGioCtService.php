...
class GachHoaThongGioCtService
{
    ...
    private const IMAGE_DIRECTORY = 'gach_hoa_thong_gio_ct/images';

    private const SIZE_DIRECTORY = 'gach_hoa_thong_gio_ct/sizes';
    ...
    public function removeVideoFromJson(int $id, string $videoUrl): GachHoaThongGioCt
    {
     ...
     */
    public function removeGalleryItemsFromJson(int $id, array $imagePaths = [], array $videoUrls = [], array $videoPaths = []): GachHoaThongGioCt
    {
